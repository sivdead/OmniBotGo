...
func InitializeApp(cfg *config.Config) (*providers.App, func(), error) {
	...
	adapter := providers.NewTelegramAdapter()
	adapterRegistry := providers.NewAdapterRegistry(wecomAdapter, dingtalkProxyAdapter, wechatOfficialAdapter, feishuAdapter, adapter)
